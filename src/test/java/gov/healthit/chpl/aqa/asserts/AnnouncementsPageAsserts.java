...
public class AnnouncementsPageAsserts extends Base {
     ...
     */
    @Then("^I see the Announcement information is recorded in Announcements Reports$")
    public void announcementInfoRecordedInAnnouncementsReports() {
        String actualAnnouncementInformation = AnnouncementsPage.announcementReportDetails(getDriver()).getText();
        assertTrue(actualAnnouncementInformation.contains("Created announcement: " + getCurrentDate()));
