...
Scenario Outline: Verify that surveillance data can be entered and is saved in a quarterly report, delete report after verification
    ...
    |ROLE_ADMIN |UL LLC           |UL LLC-2020-Q1          |Are you sure you wish to initiate quarterly surveillance reporting for quarter Q1 of year 2020? |No non-conformity|Correspondence with Complainant/Developer|Are you sure you wish to delete this Quarterly Surveillance Report?|