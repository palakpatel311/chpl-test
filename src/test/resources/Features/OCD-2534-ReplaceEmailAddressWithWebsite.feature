...
Scenario Outline: Verify in CHPL API Page
    Given I am on CHPL API page
    Then Verify the "<Content>" under Certified Health IT Product Listing and "<URL>"
    Examples: 
    |Content|URL|
    |Created by CHPL Development Team. Please submit any questions using the Health IT Feedback Form and select the "Certified Health IT Products List (CHPL)" category.|https://www.healthit.gov/form/healthit-feedback-form |
